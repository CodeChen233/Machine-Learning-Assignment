...
path=path[0:-7]
"""Directories"""
data_path =  path+'data\\original\\shanghaitech\\part_B_final\\test_data\\images\\'
gt_path = path+'data\\original\\shanghaitech\\part_B_final\\test_data\\ground_truth_csv\\'
model_path = path+'final_models\\mcnn_shtechB_110.h5'
