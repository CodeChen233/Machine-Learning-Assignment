...
path=path[0:-8]
"""Directories"""
train_path = path+'data\\formatted_trainval\\shanghaitech_part_A_patches_9\\train'
train_gt_path = path+'data\\formatted_trainval\\shanghaitech_part_A_patches_9\\train_den'
val_path = path+'data\\formatted_trainval\\shanghaitech_part_A_patches_9\\val'
val_gt_path = path+'data\\formatted_trainval\\shanghaitech_part_A_patches_9\\val_den'
